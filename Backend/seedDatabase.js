...
const projectsData = [
  {
    ...
    longDescription:
      "This is a comprehensive e-commerce platform built with modern technologies. It features user authentication, product management, shopping cart, payment integration, and admin dashboard. The frontend is built with React and styled with Tailwind CSS, while the backend uses Node.js, Express, and MongoDB.",
    technologies: [
      "React",
      "Node.js",
      "MongoDB",
  ...
  },
  {
    ...
    technologies: ["Vue.js", "Socket.io", "Node.js", "MongoDB", "Vuetify"],
    category: "web",
    status: "completed",
    featured: true,
...
const seedDatabase = async () => {
  try {
    ...
    const blogs = await Blog.insertMany(blogPosts);
